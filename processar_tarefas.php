...
try{
    ...
    $processador = new TaskProcessor(
        $repositorio,
        new TaskDispatcher(new TaskRegistry()),
        null,
        TASK_SCHEDULER_LEASE_MINUTES,
        $logger
    );
    $resumo = $processador->processarLote(TASK_SCHEDULER_BATCH_SIZE);
