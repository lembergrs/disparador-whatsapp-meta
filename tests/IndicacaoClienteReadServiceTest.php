...
INSERT INTO clientes VALUES(1, 'pago', 'Empresa Indicadora', 'Indicadora'),(2, 'pago', 'Outra Empresa', 'Outra'),(3, 'pago', 'Cliente Indicado Privado', 'Privado'),(4, 'pago', 'Cliente de Outro Indicador', 'Outro');
INSERT INTO indicacao_campanhas VALUES(1, 'Campanha atual', '15.00', 'S', 'S', NULL, NULL);
INSERT INTO indicacao_codigos VALUES(1, 1, 1, 'CODIGO-UM', 'ativo'),(2, 2, 1, 'CODIGO-DOIS', 'ativo');
...
icrAssert($dados['compartilhamento']['disponivel'] === true && $dados['compartilhamento']['codigo'] === 'CODIGO-UM', 'código pertence apenas ao cliente atual');
