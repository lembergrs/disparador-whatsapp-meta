...
regularizacaoAssert(strpos($workflow,'recuperarIntegracaoCobranca')!==false&&strpos($workflow,"Cobrança não pertence à assinatura vigente")!==false,'domínio valida propriedade e assinatura vigente');
