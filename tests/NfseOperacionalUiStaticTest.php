...
nfseOpHas($view, 'nfse-actions-dropdown', 'ações são agrupadas em dropdown');
nfseOpHas($view, 'Emitir nova NFS-e', 'cancelada permite nova emissão por ação dedicada');
nfseOpHas($view, 'nfse-child-row', 'linha expansível disponível');
nfseOpHas($view, 'nfse-toggle-row', 'controle da linha expansível disponível');
nfseOpHas($view, 'Timeline da emissão', 'modal exibe timeline da emissão');
nfseOpHas($view, 'nfse_timeline', 'timeline é gerada sem depender de logs do servidor');
