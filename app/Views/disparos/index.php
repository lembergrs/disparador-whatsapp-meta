...
<div id="areaHeaderMidiaDisparo" class="form-group" style="display:none">
    ...
    <div class="meta-media-drop border rounded p-3 text-center" data-input="header_media_envio">
        ...
        <input type="file" name="header_media_envio" id="header_media_envio" class="d-none" accept=".jpg,.jpeg,.png,.webp,.mp4,.3gpp,.pdf">
    </div>
