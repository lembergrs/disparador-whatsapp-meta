...
<p class="text-success font-weight-bold mb-1"><span class="site-valor-primeiro-pagamento">R$ <?= number_format($valorPrimeiroPagamento,2,',','.'); ?></span><span> na primeira cobrança mensal</span></p><p class="text-muted mb-1">Economia de R$ <?= number_format($valorDesconto,2,',','.'); ?>: 50% da primeira mensalidade</p><p class="mb-3">Renovação: <strong>R$ <?= number_format($valorMensal,2,',','.'); ?>/mês</strong></p>
