                            ...
                            <td class="text-nowrap">
                                <div class="dropdown nfse-actions-dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <?php if($temXml){ ?><a class="dropdown-item" href="<?= BASE_URL; ?>/index.php?url=nfse/pdf/<?= (int) $emissao['NFE_ID']; ?>" title="Gerar PDF a partir do XML armazenado">PDF</a><?php } ?>
                        ...
                        <tr class="nfse-child-row d-none"><td colspan="7">
                            <div class="p-2 bg-light border rounded">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 text-right"><?php if($temXml){ ?><a class="btn btn-xs btn-outline-primary" href="<?= BASE_URL; ?>/index.php?url=nfse/pdf/<?= (int) $emissao['NFE_ID']; ?>" title="Gerar PDF a partir do XML armazenado">PDF</a><?php } ?> <?php if($temXml){ ?><a class="btn btn-xs btn-outline-success" href="<?= BASE_URL; ?>/index.php?url=nfse/xml/<?= (int) $emissao['NFE_ID']; ?>">XML</a><?php } ?> <?= nfse_doc($emissao['NFE_ChaveAcesso'] ?? ''); ?> <?php if($status === 'emitida' && $temChave){ ?><button type="button" class="btn btn-xs btn-outline-danger" data-toggle="modal" data-target="#cancelar-<?= (int) $emissao['NFE_ID']; ?>">Cancelar</button><?php } ?></div>
                                </div>
                            </div>
                        </td></tr>
                    <?php } ?>
