...
class IndicacaoCodigo
{
 ...
 public function buscarNormalizado($c){$s=$this->db->prepare('SELECT * FROM indicacao_codigos WHERE ICD_CodigoNormalizado=?');$s->execute([$c]);return $s->fetch(PDO::FETCH_ASSOC)?:null;}
