...
class NfseController extends Controller
{
    public function index()
    {
        ...
        $this->view('nfse/index', [
            ...
            'nfseConfigPublica' => $nfseConfigPublica, 'nfseFiscalPreview' => $nfseFiscalPreview,
            'statusFiltro' => $status, 'statusPermitidos' => NfseEmissao::statusPermitidos()
        ]);
    }
    ...
    public function emitir()
    {
        ...
        try{
            $resultado = (new NfseEmissionService())->emitirManual((int) ($_POST['cliente_id'] ?? 0), (int) ($_POST['cobranca_id'] ?? 0), Auth::usuario() ?: []);
    ...
    public function pdf(){ $this->download('pdf'); }
