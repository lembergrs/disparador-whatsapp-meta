...
defined('WORKER_DAEMON_IDLE_SLEEP_SECONDS') || define('WORKER_DAEMON_IDLE_SLEEP_SECONDS', (int) env_valor('WORKER_DAEMON_IDLE_SLEEP_SECONDS', 5));
defined('WORKER_DAEMON_BUSY_SLEEP_SECONDS') || define('WORKER_DAEMON_BUSY_SLEEP_SECONDS', (int) env_valor('WORKER_DAEMON_BUSY_SLEEP_SECONDS', 1));
defined('WORKER_DAEMON_MAX_SLEEP_SECONDS') || define('WORKER_DAEMON_MAX_SLEEP_SECONDS', (int) env_valor('WORKER_DAEMON_MAX_SLEEP_SECONDS', 60));
defined('WORKER_DAEMON_MAX_RUNTIME_SECONDS') || define('WORKER_DAEMON_MAX_RUNTIME_SECONDS', (int) env_valor('WORKER_DAEMON_MAX_RUNTIME_SECONDS', 0));
defined('WORKER_DAEMON_MAX_CYCLES') || define('WORKER_DAEMON_MAX_CYCLES', (int) env_valor('WORKER_DAEMON_MAX_CYCLES', 0));
defined('WORKER_DAEMON_MEMORY_LIMIT_BYTES') || define('WORKER_DAEMON_MEMORY_LIMIT_BYTES', (int) env_valor('WORKER_DAEMON_MEMORY_LIMIT_BYTES', 0));
defined('WORKER_DAEMON_HEARTBEAT_ENABLED') || define('WORKER_DAEMON_HEARTBEAT_ENABLED', filter_var(env_valor('WORKER_DAEMON_HEARTBEAT_ENABLED', '1'), FILTER_VALIDATE_BOOLEAN));
