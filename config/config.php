...
if($uploadsPublicPath === '') $uploadsPublicPath = '/uploads';
if($uploadsPublicPath[0] !== '/') $uploadsPublicPath = '/' . $uploadsPublicPath;
...
defined('ASAAS_API_BASE_URL') || define('ASAAS_API_BASE_URL', $asaasEnv === 'production' ? $asaasBaseUrlProduction : $asaasBaseUrlSandbox);
