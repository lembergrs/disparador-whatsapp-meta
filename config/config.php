...
defined('WORKER_USAR_LOCK_COMPARTILHADO') || define('WORKER_USAR_LOCK_COMPARTILHADO', filter_var(env_valor('WORKER_USAR_LOCK_COMPARTILHADO', 'true'), FILTER_VALIDATE_BOOLEAN));
...
defined('META_COEXISTENCE_TEST_CLIENT_IDS') || define(
